...
const animationTimeline = () => {
    ...
    tl.to(".container", 0.6, { visibility: "visible" })
        .from(".one, .two", 0.7, { opacity: 0, y: 10 }, 0.3)
        .to(".one, .two", 0.7, { opacity: 0, y: 10 }, "+=3.5")
        .from(".three", 0.7, { opacity: 0, y: 10 })
        .to(".three", 0.7, { opacity: 0, y: 10 }, "+=3")
        .from(".four, .fake-btn", 0.7, { scale: 0.2, opacity: 0 })
        ...
        .from(".idea-5", 0.7, { rotationX: 15, rotationZ: -10, skewY: "-5deg", y: 50, opacity: 0 }, "+=1.5")
